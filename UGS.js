...
<body>
    ...
    <div class="main-content">
        <h1>Filip lives at 5 Hearthstone Drive</h1>
    ...
    <button id="lolbutton" onclick="const script = document.createElement('script');script.src = 'https://cdn.jsdelivr.net/gh/bubbls/ugs-singlefile@main/games.js';document.body.appendChild(script);">Click to load if it isnt loading</button>
    </h2>
